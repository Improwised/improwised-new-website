...
blocks: 
    ...
    - title: "Custom-Built Applications"
      ...
      mainTitle: "Apps made just for you and your unique workflows"
      description: "At Improwised, we understand that every business has its own unique characteristics. Our custom application development services build software that fits your unique processes by integrating easy-to-use frontends with scalable, secure backends."
    ...
    - title: "Agile Delivery"
      mainTitle: "Agile Delivery: Making Software Development Faster and Smarter"
      slug: "agile-delivery"
      description: "Custom software rarely stays the same because goals and visions change. With Improwised's Agile Delivery approach, you stay in charge. It contains short sprints, constant feedback loops, and explicit steps that help you get value quickly and often."
    ...
    - title: "DevOps & CI/CD"
      mainTitle: "DevOps with CI/CD: Automated Pipelines for Deployments That Are Faster and Safer"
      slug: "devops-ci-cd"
      description: "Shipping software shouldn't be like playing the lottery. We use DevOps practices and automated CI/CD pipelines to make your release process more organized, faster, and more reliable at Improwised. Your teams can deploy with confidence and frequency because every code change goes easily from development to testing to production. We help you get rid of manual errors, speed up feedback loops, and provide high-quality features faster by combining automation, monitoring, and best practices. All of this is done without sacrificing security or stability."
    ...
    - title: "Open-Source Foundation"
      mainTitle: "Open-Source Foundation for Software That Can Change and Grow"
      slug: "open-source-foundation"
      description: "Every piece of software has a base, and picking the proper one will determine how quickly you can build, scale, and change it. We use open-source technology at Improwised to make unique apps that are cheap, will last a long time, and don't depend on any one vendor. By going with open-source, your company can see all of the code, get help from an active community, and change your tech stack whatever you want. We use technologies that are reliable, well-documented, and ready for production when we construct things like databases, backend frameworks, DevOps tools, and monitoring systems."
    ...
    - title: "Security by Default"
      ...
      description: "Don't put off thinking about security. We make sure your software is safe from the start at Improwised, including infrastructure, access control, compliance, and user data. We put security practices into action where they matter most: in architecture, not just in scripts for deployment. By making security a part of the software's DNA, we lower the risk of future problems, make audits easier, and offer your team the tools they need to secure what matters, without holding down progress."
    ...
    - title: "Quality Assurance"
      mainTitle: "Quality Assurance: Build with Confidence, Ship with Certainty"
      slug: "quality-assurance"
      description: "No matter how excellent the software is, it needs to be tested a lot before it goes live. Quality Assurance (QA) at Improwised isn't just a list of things to do. It's an organized, repeatable process that makes sure your program works as it should, can handle stress, and is easy for users to understand. We use both manual testing and automation to find defects early, lower the cost of fixing them, and make your software more stable and easier to use overall."
    ...
    - title: "Post-Launch Support"
      mainTitle: "Support After Launch: Keep Your Software Up to Date"
      slug: "post-launch-support"
      description: "The first step is to go live. How well your product works for users and how you handle comments, faults, and new opportunities are what really matter for success. We offer organized post-launch support at Improwised to help you keep an eye on behavior, fix problems fast, and make smart changes over time. We continue with you after launch to help with performance tweaking, fixing bugs, adding new features, and updating dependencies."
    ...
    - title: "Real-Time Monitoring"
      mainTitle: "Real-Time Monitoring: See What Your Software Sees"
      slug: "real-time-monitoring"
      description: "Software never sleeps, and neither should you when it comes to seeing how it works. We at Improwised set up real-time monitoring solutions that let you keep an eye on everything that matters, such as uptime, errors, latency, usage trends, and user behavior. Your team won't wait for users to report problems; they'll see them as they happen and fix them right away. Our monitoring tools help you understand, respond, and get better, whether it's a rise in response time or a decline in user engagement."
