...
blocks: 
    - title: "In-House AI Server Lab"
      ...
      mainTitle: "In-House AI Server Lab: Make AI infrastructure that is safe and private"
      description: "Not all AI solutions should use public clouds. Data privacy is not a choice for businesses that work with private information, like healthcare, banking, law, or IP-driven R&D. That's why Improwised set up an AI server lab in own office. This is a safe and efficient place to create, improve, and deploy AI models. We set up servers that provide full control, compliance, and performance, whether testing out open-source LLMs or putting production-ready inference pipelines into action."
    ...
    - title: "Custom AI Agents"
      mainTitle: "LLM-Powered Custom AI Agents: Tools Made Just for Your Business"
      slug: "custom-ai-agents"
      description: "There are different ways that each firm works, and not all AI tools can keep up. We make unique AI agents at Improwised that are based on open-source or private large language models (LLMs), trained on your processes, kept safe in your environment, and optimized for real-world results. We make sure that each AI agent works the way your teams do, not the other way around. This could be an internal dev copilot, a support automation assistant, or a documentation agent."
    ...
    - title: "Internal Efficiency Boosters"
      mainTitle: "AI that works behind the scenes to make things run more smoothly"
      slug: "internal-efficiency-boosters"
      description: "Not every AI agent has to talk to customers. Some of the most important ways to employ AI occur behind the scenes, with your own teams. We make AI tools for our own use at Improwised that help developers create better code, QA teams test faster, and managers keep better records. These aren't ready-made tools; they're AI copilots made just for how your team works."
    ...
    - title: "Integrated into Client Projects"
      mainTitle: "AI built into client projects: platforms that are smarter by design"
      slug: "integrated-into-client-projects"
      description: "AI is really useful when it's not just an extra tool but a built-in aspect of how you use your product. At Improwised, we put intelligent agents right into the platforms we design. This makes complicated activities easier, gives users better suggestions, and makes interactions with end users better. These aren't spectacular features; they're useful, safe, and closely related to how you use them. They include smart form completion and AI-powered search."
    ...
    - title: "Private & Secure: AI Without Data Exposure"
      mainTitle: "AI Without Data Exposure: Private and Safe"
      slug: "private-and-secure"
      description: "For many organizations, especially in healthcare, banking, legal, or government, data privacy is non-negotiable. We help you design and run AI systems in safe places that you have complete control over at Improwised. We make sure that your AI innovation doesn't come at the cost of data sovereignty, whether it's a self-hosted LLM, an isolated training loop, or a containerized deployment."
      ...
      featureTitle: "Why Private AI Is Important"
    ...
    - title: "R&D-Driven Iteration"
      mainTitle: "R&D-Driven Iteration: Using Open Innovation to Improve AI"
      slug: "rd-driven-iteration"
      description: "AI tools are changing every week, not every year. We keep ahead at Improwised by doing structured R&D sprints that test, break, and confirm the newest AI models and frameworks. Our purpose is clear to assist clients in adopting what's proven, not just what's popular. This could be testing a novel retrieval method or looking at the trade-offs between LLM latency and other factors. Our AI lab looks at new ways to use open-source transformers and prompt orchestration tools so that your business may use them quickly, safely, and with confidence."
    ...
    - title: "Faster Delivery Cycles with AI-Driven Development"
      ...
      description: "It's not just about speed when you build software; it's about speed with confidence. We employ agentic AI technologies at Improwised to speed up the whole delivery cycle, from planning to release, without sacrificing code quality, team cooperation, or compliance. By adding smart agents to our internal processes, we cut down on extra work, automate repetitive tasks, and let developers focus on what really matters: solving issues instead of fighting processes."
      ...
      featureTitle: "Why do delivery cycles" 
      featureSubTitle: "that are faster matter" 
