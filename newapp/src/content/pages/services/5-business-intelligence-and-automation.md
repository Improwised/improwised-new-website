...
blocks: 
    - title: "Data Centralization"
      ...
      mainTitle: "Data Centralization Services to Help You Make Better, More Unified Business Decisions"
      description: "There is a lot of data out there, but useful information is often stuck in systems that don't talk to each other. With Improwised's Data Centralization Services, businesses that are ahead of the curve can combine all of their important data into one platform. This gets rid of silos, makes things more consistent, and lets everyone in the organization see what's going on. With a consolidated data approach, your teams can make choices faster, ensure that KPIs are in line, and ensure that rules are followed at every step."
    ...
    - title: "Real-Time Reporting"
      mainTitle: "Reporting in real time helps you make decisions faster and smarter."
      slug: "real-time-reporting"
      description: "Old reports don't work in today's world, because everything is always on. Improwised allows you to go from old spreadsheets to dashboards that show you real company data. Our real-time reporting tools help people who make decisions respond to changes as they happen. This speeds things up, makes them more accurate, and makes sure everyone is on the same page."
    ...
    - title: "Automated Workflows"
      mainTitle: "Automated workflows that help things go more easily and quickly"
      slug: "automated-workflows"
      description: "Imagine that the things you do every day, like receiving approvals, entering data, and sending notifications, happen on their own. Our Automated Workflows system handles your HR, finance, sales, and operations automatically. This means less work for people and makes sure that everything in your company is the same."
    ...
    - title: "System Integration"
      mainTitle: "A way to connect CRMs, ERPs, and analytics systems easily"
      slug: "system-integration"
      description: "Salesforce, SAP, HubSpot, and other platforms save your data, but they don't talk to each other. Our system integration solution connects several platforms so that data can move rapidly, processes can be made easier, and everyone in the company can better understand what's going on."
    ...
    - title: "Role-Based Access & Compliance"
      mainTitle: "Secure Role‑Based Access & Compliance Controls for Data Confidence"
      slug: "role-based-access-compliance"
      description: "Securing your data isn't optional - it’s essential. Improwised’s Role‑Based Access & Compliance service ensures your teams see only what they need, while meeting industry regulations—so your data stays both useful and protected."
    ...
    - title: "KPI Tracking & Alerts"
      mainTitle: "KPI Tracking & Alerts for Proactive, Performance-Driven Decisions"
      slug: "kpi-tracking-alerts"
      description: "Say goodbye to missed opportunities and late reactions. Improwised's KPI Tracking & Alerts service keeps your teams informed with real-time metrics and proactive alerts—empowering you to act on data before it’s too late."
    ...
    - title: "Custom Modules & Support"
      mainTitle: "Custom Modules & Ongoing Support to Fit Your Unique BI Needs"
      slug: "custom-modules-support"
      description: "Every organization is different - and so are your analytics needs. Improwised offers Custom BI Modules & Support, tailored to your workflows and tech stack. From extensions to continuous improvements, we ensure your BI platform evolves as you do."
